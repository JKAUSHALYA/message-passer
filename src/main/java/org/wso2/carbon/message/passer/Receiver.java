...
public class Receiver {
    ...
    public Receiver(List<MessageReceiver> messageReceivers) {
    ...
    public void register(MessageReceiveEventHandler messageReceiveEventHandler) {
        ...
        for (MessageReceiver messageReceiver : messageReceivers) {
            messageReceiver.register(messageReceiveEventHandler);
        }
    }
    ...
    public void unregister(MessageReceiveEventHandler messageReceiveEventHandler) {
        ...
        for (MessageReceiver messageReceiver : messageReceivers) {
            messageReceiver.unregister(messageReceiveEventHandler);
        }
    }
}